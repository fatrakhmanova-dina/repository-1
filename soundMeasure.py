...
try:
    ...
    write_list(data[0], '/home/b03-404/Фатрахманова_Шишкин_Немальцев/data_0_co2.txt')
    write_list(data[1], '/home/b03-404/Фатрахманова_Шишкин_Немальцев/data_1_co2.txt')
